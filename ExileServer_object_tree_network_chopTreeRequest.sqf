...
params["_sessionId", "_parameters", "_treeNetId", "_tree", "_isTree", "_player", "_treeHeight", "_newDamage", "_weaponHolders", "_weaponHolder", "_weaponHolderPosition"];
...
try 
{
	...
	_weaponHolders = nearestObjects[_player, ["GroundWeaponHolder"], 4];
